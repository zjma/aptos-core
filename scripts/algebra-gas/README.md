...
Combined with the [pre-defined](https://github.com/aptos-labs/aptos-core/blob/28df4c1f0ea0d6c6dc6b0460257aa9086e830d1a/aptos-move/aptos-gas/src/move_stdlib.rs#L17-L18) SHA2-256 gas formula (internal gas):`g(n)=1000n+60000`,
it can be calculated that `gas_per_ns = 1000/k`.
